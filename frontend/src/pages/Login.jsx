      ...
      <div className={`relative z-10 bg-white rounded-xl shadow-lg p-8 w-full max-w-md transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-600 to-teal-600">MediCare Connect</span>
          </h1>
        ...
        <div className="mt-8 text-center">
          <p className="text-slate-500 mb-4">Don't have an account? 
            <Link to="/register" className="text-teal-600 hover:text-teal-700 ml-1">Create Account</Link>
          </p>
